...
| 🌳 **Vegetation** | Urban tree and green space coverage across districts |

---

## Access

The platform is restricted to authorized users. Access is granted via **email OTP (one-time password)**:

1. Go to [windantwerpen.robermamani.com](https://windantwerpen.robermamani.com/)
2. Enter your authorized email address
3. Receive a 6-digit code in your inbox
4. Enter the code to access the platform

Codes expire after **10 minutes** and can only be used once.

---

*© 2025 Wind in Antwerp · City of Antwerp*